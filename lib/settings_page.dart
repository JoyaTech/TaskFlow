...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> _saveSettings() async {
    ...
    await secureStorage.storeOpenAIApiKey(_openaiController.text.trim());
    await secureStorage.storeGeminiApiKey(_geminiController.text.trim());
    await secureStorage.storeGoogleApiKey(_googleApiController.text.trim());
    await secureStorage.storeGmailApiKey(_gmailApiController.text.trim());
    await secureStorage.storeCalendarApiKey(_calendarApiController.text.trim());
    await prefs.setBool('voice_enabled', _voiceEnabled);
    await prefs.setBool('notifications_enabled', _notificationsEnabled);
    await prefs.setString('wake_word', _selectedWakeWord);
