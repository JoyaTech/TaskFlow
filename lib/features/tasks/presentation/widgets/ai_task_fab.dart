...
/// AI-powered FloatingActionButton - The "Magic" Button for MindFlow
class AITaskFab extends ConsumerStatefulWidget {
  const AITaskFab({super.key});

  @override
  ConsumerState<AITaskFab> createState() => _AITaskFabState();
}

class _AITaskFabState extends ConsumerState<AITaskFab>
  ...
  void _showAIMenu() {
    showModalBottomSheet(
      ...
      builder: (context) => const AIMenuBottomSheet(),
    );
  }
}

/// Bottom sheet with AI options
class AIMenuBottomSheet extends ConsumerWidget {
  const AIMenuBottomSheet({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'בחר איך תרצה ליצור משימות בצורה חכמה',
            ...
            _buildAIOption(
              ...
              subtitle: 'תגיד מה אתה צריך והאפליקציה תבין',
              color: Colors.red,
            ...
            _buildAIOption(
              ...
              title: 'כתיבה חכמה',
              subtitle: 'כתוב בשפה טבעית והמערכת תבין',
              color: Colors.blue,
            ...
            _buildAIOption(
              ...
              subtitle: 'המר אימיילים למשימות אוטומטית',
              color: Colors.green,
            ...
            _buildAIOption(
              ...
              subtitle: 'קבל עזרה להתמודדות עם עומס',
              color: Colors.orange,
  ...
  Future<void> _handleVoiceInput(BuildContext context, WidgetRef ref) async {
    ...
    if (micPermission != PermissionStatus.granted) {
      if (context.mounted) {
        _showPermissionDeniedDialog(context, 'מיקרופון');
      }
      return;
    }
  ...
  void _handleEmailScan(BuildContext context, WidgetRef ref) {
    Navigator.pop(context);
    // Trigger email scan
    ref.read(aiTaskProcessingProvider.notifier).scanEmails();
    
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('סורק אימיילים למשימות חדשות...'),
  ...
  void _showPermissionDeniedDialog(BuildContext context, String permission) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('נדרש רישיון'),
        content: Text('כדי להשתמש בתכונה זו, יש לאפשר גישה ל$permission'),
        actions: [
          TextButton(
...
/// Dialog for helping overwhelmed users
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () {
            Navigator.pop(context);
            // TODO: Implement smart task breakdown
          },
          child: const Text('עזור לי לפרק משימות'),
        ),
      ],
    );
  }
