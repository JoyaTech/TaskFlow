...
/// Simple Smart AI FAB - Shows the UI with API key detection but uses demo for now
class SimpleSmartAITaskFab extends ConsumerStatefulWidget {
  const SimpleSmartAITaskFab({super.key});

  @override
  ConsumerState<SimpleSmartAITaskFab> createState() => _SimpleSmartAITaskFabState();
}

class _SimpleSmartAITaskFabState extends ConsumerState<SimpleSmartAITaskFab>
  ...
  void _showAIMenu() {
    showModalBottomSheet(
      ...
      builder: (context) => SimpleSmartAIMenuBottomSheet(
...
class SimpleSmartAIMenuBottomSheet extends ConsumerWidget {
  final bool hasApiKey;
  final VoidCallback onRefreshApiKey;

  const SimpleSmartAIMenuBottomSheet({
    super.key,
          ...
          child: Column(
            ...
            if (hasApiKey) ...[
              ...
              Container(
                ...
                child: Text(
                  '🎉 מעולה! יש לך API key. אמנם הפיצ\'רים הם עדיין דמו להדגמה, אבל המערכת מוכנה לחיבור האמיתי!',
                  style: TextStyle(
            ...
            Text(
              hasApiKey 
                  ? 'המערכת מוכנה לחיבור! (כרגע מריצה דמו להדגמה)'
            ...
            // AI Options - always use demo for now
            _buildAIOption(
              context: context,
              icon: Icons.mic,
              title: 'הקלטה קולית חכמה',
              subtitle: 'תגיד מה אתה צריך והאפליקציה תבין (הדגמה)',
              color: Colors.red,
            ...
            _buildAIOption(
              ...
              title: 'כתיבה חכמה',
              subtitle: 'כתוב בשפה טבעית והמערכת תבין (הדגמה)',
              color: Colors.blue,
            ...
            _buildAIOption(
              ...
              subtitle: 'המר אימיילים למשימות אוטומטית (הדגמה)',
              color: Colors.green,
            ...
            _buildAIOption(
              ...
              subtitle: 'קבל עזרה להתמודדות עם עומס (הדגמה)',
              color: Colors.orange,
  ...
  void _handleEmailScan(BuildContext context, WidgetRef ref) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('סורק אימיילים למשימות חדשות... (הדגמה)'),
      ),
    );
  }
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text('עזור לי לפרק משימות (הדגמה)'),
          ),
        ],
      ),
    );
